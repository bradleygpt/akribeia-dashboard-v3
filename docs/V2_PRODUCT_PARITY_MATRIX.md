...
| `/api/quote`                | Single-symbol daily/intraday quote                        | `s-maxage=120, stale-while-revalidate=900`                                            | Wave 2                                                                                |
| `/api/quotes`               | Batched symbol quotes                                     | `s-maxage=120, stale-while-revalidate=600`                                            | Wave 2                                                                                |
...
strategies, theses, ticker-anchor mappings and system/watchdog status. These remain open in Waves
2–4. `v2/main:public/data/freshness_manifest.json` is the pointer and provenance source for bulk
...
| Risk metrics                                             | `v2/main:src/lib/risk.ts`, `v2-source/main:risk_metrics.py`, preserved risk oracle                  | calculation regression coverage present; UI deferred                                                                                     |
...
| Universe controls                      | floor/preset controls in `Sidebar`; screener search/filter/sort; localStorage watchlist and custom weights in `store.tsx` | Wave 1 restores full-universe search, sector filtering and sorting; advanced presets/watchlists remain Wave 2               |
